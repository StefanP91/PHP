...
<body class="d-flex flex-column min-vh-100">
    ...
    <main class="container-fluid flex-grow-1 bg-info-subtle justify-content-center">
        <div class="d-flex justify-content-center align-items-center my-5">
            <div class="card p-3 w-25">
                ...
                <?php if(isset($_SESSION['login'])): ?>
                    <form action="modules/addToCart.php" method="post" class="d-flex gap-4">
                        <input type="hidden" name="id" value="<?= $product['id'] ?>">
                        <input class="form-control" type="text" name="quantity" placeholder="Quantity">
                        <button type="submit" class="btn btn-outline-primary text-nowrap">Add to cart</button>
                    </form>

                <?php else: ?>
                    <p>You must be logged in to add product to cart</p>
